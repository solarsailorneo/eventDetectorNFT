...
var base = require('../../../dist/base-900b7d10.cjs.dev.js');
...
class WalletLinkConnector extends base.Connector {
  constructor(config) {
    ...
    base._defineProperty(this, "_client", void 0);

    base._defineProperty(this, "_provider", void 0);
  ...
  connect() {
    ...
    return base._asyncToGenerator(function* () {
      try {
        ...
        if (error.message === 'User closed modal') throw new base.UserRejectedRequestError();
        throw error;
      }
    })();
  }
  ...
  getProvider() {
    if (!this._provider) {
      this._client = new walletlink.WalletLink(this.options);
